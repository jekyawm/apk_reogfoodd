            ...
            <div class="card">
                ...
                <div class="card-body">
                    @auth
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#userModal{{ $user->id }}">View</button>
                        ...
                        {{ $users->links() }}
                    @else
                        <p>Kamu Belum Login. Silahkan <a href="{{ route('signin') }}">log in</a> Terlebih Dahulu.</p>
                    @endauth
                </div>
            </div>
        </div>
